...
# DaskDistributed('a',8) #a: automated, m: manual, #: number of cores logical processors
...
from AIAlgorithms_AI_v01 import MultiLabel_RF as MultiLabel_RF
