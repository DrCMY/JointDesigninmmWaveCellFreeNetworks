...
# DaskDistributed('a',2) #a: automated, m: manual, #: number of logical processors
...
from AIAlgorithms_AI_v01 import MultiLabel_LinearSVC as MultiLabel_LinearSVC
...
for iter in range(0,len(selected)):
    ...
    # MultiLabel_LinearSVC - function
    decision=MultiLabel_LinearSVC(Xtrain,Ytrain,Xtest)        
